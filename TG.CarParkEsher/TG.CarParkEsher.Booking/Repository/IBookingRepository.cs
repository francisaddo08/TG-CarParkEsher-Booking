...
namespace TG.CarParkEsher.Booking
{
    public interface IBookingRepository
    {
        ...
        Task<Result<List<CarParkEsherDetail>>> GetPermittedParkingSpaces(bool blueBadge, bool ev, bool hybrid, DateTime startDate, DateTime? endDate, CancellationToken cancellationToken);
    }
}