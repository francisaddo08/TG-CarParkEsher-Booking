...
namespace TG.CarParkEsher.Booking
{
    ...
    {
        public EmployeeRepository(ILoggingService logger, IOptionsMonitor<ConnectionOption> connectionOption, IWebHostEnvironment webHost) : base(logger, connectionOption, webHost)
        {
        }
